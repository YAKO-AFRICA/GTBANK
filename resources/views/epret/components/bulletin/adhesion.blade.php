...
<body>
    ...
    @php
        ...
        $primeTotal = ($pret->primeobseque ?? 0) + ($pret->primeemprunteur ?? 0) + ($pret->montantsurprime ?? 0);
    @endphp
    ...
    <div class="a4-container" style=" width: 100%; margin: 0 auto;">
        ...
        <table border="1" class="table" style="width: 100%; font-size: 8px; text-align: left;">
            ...
            <tbody>
                <tr>
                    <td>{{ number_format($pret->primeemprunteur, 2, ',', '.') }}</td>
                    <td>
                    ...
                    <td>{{ number_format($pret->montantsurprime, 2, ',', '.') ?? '0' }}</td>
