...
<div class="row g-3 mb-3">
    <div class="col-12">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" @if (isset($simulationData['genre']) && $simulationData['genre'] == 'femme') checked
                
            @endif type="radio" name="civilite" id="inlineRadio1" value="Madame" autocomplete="on" required readonly data-invalid-message="Veuillez cocher la civilité">
            <label class="form-check-label" for="inlineRadio1">Madame</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" @if (isset($simulationData['genre']) && $simulationData['genre'] == 'femme') checked @endif type="radio" name="civilite" id="inlineRadio2" value="Mademoiselle" autocomplete="on" readonly>
            <label class="form-check-label" for="inlineRadio2">Mademoiselle</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" @if (isset($simulationData['genre']) && $simulationData['genre'] == 'homme') checked @endif type="radio" name="civilite" id="inlineRadio3" value="Monsieur" autocomplete="on" readonly>
