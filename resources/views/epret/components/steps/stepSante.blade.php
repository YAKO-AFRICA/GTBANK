...
<div class="row g-3 mb-4">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="tensionMin" name="tensionMin" value="{{ $simulationData['tensionSysto'] ?? '-' }}" readonly required>
        {{-- <select name="tensionMin" id="" class="form-select" required readonly>
            <option class="form-option" value="{{ $simulationData['tensionSysto'] ?? 0 }}">{{ $simulationData['tensionSysto'] ?? 0 }}</option>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="tensionMax" name="tensionMax" value="{{ $simulationData['tensionDiasto'] ?? '-' }}" readonly required>
        {{-- <select name="tensionMax" id="tensionMax" class="form-select" required readonly>
            <option class="form-option" value="{{ $simulationData['tensionDiasto'] ?? 0 }}">{{ $simulationData['tensionSysto'] ?? 0 }}</option>
           ...
           <div class="row">
                <div class="mb-3 col">
                    ...
                    <div class="form-check">
                        ...
                        @if (($simulationData['diabete'] ?? '-') == 'oui') checked @endif readonly>
                    ...
                    <div class="form-check">
                        ...
                        @if (($simulationData['diabete'] ?? '-') == 'non') checked @endif readonly>
