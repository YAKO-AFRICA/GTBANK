                        ...
                        {{-- <div class="card">
                            <button class="btn btn-outline-success">
                                <a href="{{ route('epret.QmedicalPrint')}}" target="_blank">
                                    ...
                                    <div class="menu-title"> Telecharger le Questionnaire Medical</div>
                                </a>
                            </button>
                        </div> --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="result-container alert bg-light-success">
                                <dl class="row">
                                    ...
                                    <div class="d-none">
                                        <dt class="col-sm-6 font-weight-bold">Prime Vie emprunteur :</dt>
                                        <dd class="col-sm-6 font-weight-bold" id="primeEmprunteu">{{ number_format($simulationData['primeEmprunteur'] ?? '0', 2) }} Fcfa</dd>
                                    </div>
                                    ...
                                    <dt class="col-sm-6 font-weight-bold">Surprime :</dt>
                                    <dd class="col-sm-6 font-weight-bold" id="primeObseque">{{ number_format($simulationData['totalSurprime'] ?? '0', 2)  }} Fcfa</dd>
